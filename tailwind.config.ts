...
const config: Config = {
  ...
  theme: {
    colors: {
      ...
      "theme-secondary-900-rgba":
        "rgba(var(--theme-color-secondary-900-rgb), var(--tw-bg-opacity))",
    ...
    extend: {
      ...
      backgroundImage: {
        "radial-gradient":
          "radial-gradient(circle at center, var(--tw-gradient-from, var(--theme-color-primary-400)), var(--tw-gradient-to, var(--theme-color-primary-800)))",
      },
      backgroundSize: {
        "200": "200% 200%",
      },
